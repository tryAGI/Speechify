...
namespace Speechify
{
    public partial class SubpackageTtsSubpackageTtsKnowledgeBasesClient
    {
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement s_CreateTextDocumentSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_CreateTextDocumentSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_CreateTextDocumentSecurityRequirement0,
            };
        partial void PrepareCreateTextDocumentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::Speechify.TtsCreateTextDocumentRequest request);
        ...
        partial void ProcessCreateTextDocumentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.TtsKnowledgeBaseDocument> CreateTextDocumentAsync(
            string id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Speechify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Speechify.AutoSDKHttpResponse<global::Speechify.TtsKnowledgeBaseDocument>> CreateTextDocumentAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateTextDocumentSecurityRequirements,
                operationName: "CreateTextDocumentAsync");
            ...
            try
            {
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateTextDocumentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateTextDocumentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Speechify.TtsKnowledgeBaseDocument.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Speechify.AutoSDKHttpResponse<global::Speechify.TtsKnowledgeBaseDocument>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Speechify.TtsKnowledgeBaseDocument.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.TtsKnowledgeBaseDocument> CreateTextDocumentAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Speechify.TtsCreateTextDocumentRequest
            {
                Name = name,
                Content = content,
                FolderId = folderId,
