...
namespace Speechify
{
    public partial class DocumentsClient
    {
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement s_QueryDocumentsSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_QueryDocumentsSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_QueryDocumentsSecurityRequirement0,
            };
        partial void PrepareQueryDocumentsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string storeId,
            ref string collection,
            ref string? speechifyVersion,
            global::Speechify.StoreDocumentQuery request);
        partial void PrepareQueryDocumentsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::Speechify.StoreDocumentQuery request);
        partial void ProcessQueryDocumentsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessQueryDocumentsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.QueryStoreDocumentsResponse> QueryDocumentsAsync(
            string storeId,
            string collection,
        ...
        {
            var __response = await QueryDocumentsAsResponseAsync(
                storeId: storeId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Speechify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Speechify.AutoSDKHttpResponse<global::Speechify.QueryStoreDocumentsResponse>> QueryDocumentsAsResponseAsync(
            string storeId,
            string collection,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareQueryDocumentsArguments(
            ...
            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_QueryDocumentsSecurityRequirements,
                operationName: "QueryDocumentsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Speechify.PathBuilder(
                                path: $"/v1/stores/{storeId}/collections/{collection}/documents/query",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Speechify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "QueryDocumentsAsync",
                                pathTemplate: "$\"/v1/stores/{storeId}/collections/{collection}/documents/query\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessQueryDocumentsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Speechify.QueryStoreDocumentsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Speechify.AutoSDKHttpResponse<global::Speechify.QueryStoreDocumentsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Speechify.QueryStoreDocumentsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.QueryStoreDocumentsResponse> QueryDocumentsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Speechify.StoreDocumentQuery
            {
                Where = where,
                OrderBy = orderBy,
                Limit = limit,
