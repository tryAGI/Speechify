...
namespace Speechify
{
    ...
    /// </summary>
    public static class TtsTestTypeExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this TtsTestType value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static TtsTestType? ToEnum(string value)
        {
            return value switch
            {
