...
namespace Speechify
{
    public partial class SubpackageTtsSubpackageTtsAudioClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.TtsAudioStreamResponse200> StreamAsync(
            global::Speechify.TtsV1AudioStreamPostParametersAccept accept,
                    ...
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Speechify.TtsAudioStreamResponse200.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Speechify.TtsAudioStreamResponse200.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
