...
namespace Speechify
{
    ...
    public sealed partial class TtsListBatchCallsResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.IList<global::Speechify.TtsBatchCall> Batches { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TtsListBatchCallsResponse" /> class.
        /// </summary>
        /// <param name="hasMore">
        /// True when more rows exist beyond this page.
        /// </param>
...
#endif
        public TtsListBatchCallsResponse(
            bool hasMore,
            global::System.Collections.Generic.IList<global::Speechify.TtsBatchCall> batches,
            string? nextCursor)
        {
