...
namespace Speechify
{
    public partial class SubpackageTtsSubpackageTtsWorkspacesClient
    {
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement s_UpdateCurrentSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_UpdateCurrentSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_UpdateCurrentSecurityRequirement0,
            };
        partial void PrepareUpdateCurrentArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Speechify.TtsUpdateWorkspaceRequest request);
        partial void PrepareUpdateCurrentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Speechify.TtsUpdateWorkspaceRequest request);
        partial void ProcessUpdateCurrentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateCurrentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.TtsTenant> UpdateCurrentAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateCurrentSecurityRequirements,
                operationName: "UpdateCurrentAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Speechify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateCurrentAsync",
                                pathTemplate: "\"/v1/tenants/current\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateCurrentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Speechify.TtsTenant.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Speechify.TtsTenant.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.TtsTenant> UpdateCurrentAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Speechify.TtsUpdateWorkspaceRequest
            {
                Name = name,
            };

            return await UpdateCurrentAsync(
                request: __request,
                requestOptions: requestOptions,
