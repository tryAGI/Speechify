...
namespace Speechify
{
    public partial class TestsClient
    {
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement s_RunTargetedTestsSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_RunTargetedTestsSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_RunTargetedTestsSecurityRequirement0,
            };
        partial void PrepareRunTargetedTestsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? speechifyVersion,
            ref string? idempotencyKey,
            global::Speechify.RunTargetedTestsRequest request);
        partial void PrepareRunTargetedTestsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? speechifyVersion,
            string? idempotencyKey,
            global::Speechify.RunTargetedTestsRequest request);
        partial void ProcessRunTargetedTestsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRunTargetedTestsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.RunAgentTestsResponse> RunTargetedTestsAsync(
        ...
        {
            var __response = await RunTargetedTestsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Speechify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Speechify.AutoSDKHttpResponse<global::Speechify.RunAgentTestsResponse>> RunTargetedTestsAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRunTargetedTestsArguments(
            ...
            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RunTargetedTestsSecurityRequirements,
                operationName: "RunTargetedTestsAsync");
            ...
            __httpRequest.Headers.TryAddWithoutValidation("Idempotency-Key", __idempotencyKey);
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRunTargetedTestsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Speechify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RunTargetedTests",
                                methodName: "RunTargetedTestsAsync",
                                pathTemplate: "\"/v1/agents/tests/runs\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRunTargetedTestsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRunTargetedTestsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.RunAgentTestsResponse> RunTargetedTestsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Speechify.RunTargetedTestsRequest
            {
                TestIds = testIds,
                Target = target,
            ...
            return await RunTargetedTestsAsync(
                speechifyVersion: speechifyVersion,
                idempotencyKey: idempotencyKey,
                request: __request,
                requestOptions: requestOptions,
