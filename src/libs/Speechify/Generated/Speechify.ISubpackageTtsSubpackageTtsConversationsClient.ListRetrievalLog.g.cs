...
namespace Speechify
{
    public partial interface ISubpackageTtsSubpackageTtsConversationsClient
    {
        ...
        global::System.Threading.Tasks.Task<global::Speechify.TtsListRetrievalLogsResponse> ListRetrievalLogAsync(
            string id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Speechify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Speechify.AutoSDKHttpResponse<global::Speechify.TtsListRetrievalLogsResponse>> ListRetrievalLogAsResponseAsync(
            string id,
            string? cursor = default,
            int? limit = default,
            global::Speechify.AutoSDKRequestOptions? requestOptions = default,
