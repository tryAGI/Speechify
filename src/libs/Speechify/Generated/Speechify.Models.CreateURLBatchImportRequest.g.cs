...
{
    /// <summary>
    /// Body for POST /v1/knowledge-bases/{kb_id}/documents/urls. Submit<br/>
    ...
    public sealed partial class CreateURLBatchImportRequest
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateURLBatchImportRequest" /> class.
        /// </summary>
...
#endif
        public CreateURLBatchImportRequest(
