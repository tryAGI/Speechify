...
namespace Speechify
{
    ...
    public sealed partial class ListAgentSkillsResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.IList<global::Speechify.AgentSkill> Skills { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAgentSkillsResponse" /> class.
        /// </summary>
        /// <param name="hasMore">
        /// True when more rows exist beyond this page.
        /// </param>
...
#endif
        public ListAgentSkillsResponse(
            bool hasMore,
            global::System.Collections.Generic.IList<global::Speechify.AgentSkill> skills,
            string? nextCursor)
        {
