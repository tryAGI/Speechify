...
namespace Speechify
{
    public partial class SubpackageTtsSubpackageTtsWorkspacesClient
    {
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement s_CreateInviteSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_CreateInviteSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.TtsInvite> CreateInviteAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            var __pathBuilder = new global::Speechify.PathBuilder(
                                path: "/v1/tenants/current/invites",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Speechify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "\"/v1/tenants/current/invites\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Speechify.TtsInvite.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Speechify.TtsInvite.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.TtsInvite> CreateInviteAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Speechify.TtsCreateInviteRequest
            {
                Email = email,
            };
