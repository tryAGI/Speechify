...
namespace Speechify
{
    public partial class SubpackageTtsSubpackageTtsAuthClient
    {


        private static readonly global::Speechify.EndPointSecurityRequirement s_CreateAccessTokenSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_CreateAccessTokenSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.TtsAccessToken> CreateAccessTokenAsync(
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Speechify.TtsOAuthError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Speechify.TtsOAuthError.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw new global::Speechify.ApiException<global::Speechify.TtsOAuthError>(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Speechify.TtsAccessToken.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Speechify.TtsAccessToken.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.TtsAccessToken> CreateAccessTokenAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Speechify.TtsCreateAccessTokenRequest
            {
                GrantType = grantType,
                Scope = scope,
            };
