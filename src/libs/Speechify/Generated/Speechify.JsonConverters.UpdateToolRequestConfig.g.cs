...
{
    /// <inheritdoc />
    public class UpdateToolRequestConfigJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Speechify.UpdateToolRequestConfig>
    {
        /// <inheritdoc />
        public override global::Speechify.UpdateToolRequestConfig Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("long_running")) __score0++;
            if (__jsonProps.Contains("long_running.additional_filler_messages")) __score0++;
            if (__jsonProps.Contains("long_running.filler_delay_ms")) __score0++;
            ...
            if (__jsonProps.Contains("long_running.additional_filler_messages")) __score2++;
            if (__jsonProps.Contains("long_running.filler_delay_ms")) __score2++;
            ...
            if (__jsonProps.Contains("max_requests_per_minute")) __score2++;
            if (__jsonProps.Contains("response_mappings")) __score2++;
            ...
            if (__jsonProps.Contains("base_url")) __score3++;
            if (__jsonProps.Contains("max_requests_per_minute")) __score3++;
            if (__jsonProps.Contains("operations")) __score3++;
            if (__jsonProps.Contains("spec_url")) __score3++;
            ...
            global::Speechify.OpenAPIToolConfig? openAPIToolConfig = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 3)
                {
                    try
                    {
                        ...
                        openAPIToolConfig = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (webhookToolConfig == null && clientToolConfig == null && mCPToolConfig == null && openAPIToolConfig == null)
            {
                try
                {
            ...
            var __value = new global::Speechify.UpdateToolRequestConfig(
                webhookToolConfig,
        ...
        public override void Write(
            ...
            global::Speechify.UpdateToolRequestConfig value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
