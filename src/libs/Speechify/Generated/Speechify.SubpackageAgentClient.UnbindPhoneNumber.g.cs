...
namespace Speechify
{
    public partial class SubpackageAgentClient
    {
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement s_UnbindPhoneNumberSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_UnbindPhoneNumberSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_UnbindPhoneNumberSecurityRequirement0,
            };
        ...
        partial void ProcessUnbindPhoneNumberResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UnbindPhoneNumberSecurityRequirements,
                operationName: "UnbindPhoneNumberAsync");
            ...
            try
            {
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUnbindPhoneNumberResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUnbindPhoneNumberResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
