...
namespace Speechify
{
    public partial class SubpackageAgentSubpackageAgentIvrMemoryClient
    {
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement s_InvalidateSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_InvalidateSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_InvalidateSecurityRequirement0,
            };
        ...
        partial void ProcessInvalidateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_InvalidateSecurityRequirements,
                operationName: "InvalidateAsync");
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessInvalidateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> InvalidateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Speechify.InvalidateIVRMenuRequest
            {
                Reason = reason,
            };
