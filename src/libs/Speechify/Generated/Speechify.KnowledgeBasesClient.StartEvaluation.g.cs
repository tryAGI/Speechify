...
namespace Speechify
{
    public partial class KnowledgeBasesClient
    {
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement s_StartEvaluationSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_StartEvaluationSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_StartEvaluationSecurityRequirement0,
            };
        partial void PrepareStartEvaluationArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string kbId,
            ref string? speechifyVersion,
            ref string? idempotencyKey,
            global::Speechify.StartKnowledgeBaseEvaluationRequest request);
        partial void PrepareStartEvaluationRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::Speechify.StartKnowledgeBaseEvaluationRequest request);
        partial void ProcessStartEvaluationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessStartEvaluationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.KnowledgeBaseEvaluation> StartEvaluationAsync(
            string kbId,
        ...
        {
            var __response = await StartEvaluationAsResponseAsync(
                kbId: kbId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Speechify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Speechify.AutoSDKHttpResponse<global::Speechify.KnowledgeBaseEvaluation>> StartEvaluationAsResponseAsync(
            string kbId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareStartEvaluationArguments(
            ...
            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_StartEvaluationSecurityRequirements,
                operationName: "StartEvaluationAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Speechify.PathBuilder(
                                path: $"/v1/agents/knowledge-bases/{kbId}/evaluations",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Speechify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "StartEvaluationAsync",
                                pathTemplate: "$\"/v1/agents/knowledge-bases/{kbId}/evaluations\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessStartEvaluationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessStartEvaluationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Speechify.KnowledgeBaseEvaluation.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Speechify.AutoSDKHttpResponse<global::Speechify.KnowledgeBaseEvaluation>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Speechify.KnowledgeBaseEvaluation.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.KnowledgeBaseEvaluation> StartEvaluationAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Speechify.StartKnowledgeBaseEvaluationRequest
            {
                TopK = topK,
            };

            return await StartEvaluationAsync(
                kbId: kbId,
                speechifyVersion: speechifyVersion,
                idempotencyKey: idempotencyKey,
                request: __request,
