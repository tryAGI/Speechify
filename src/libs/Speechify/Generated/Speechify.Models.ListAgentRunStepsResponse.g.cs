...
namespace Speechify
{
    ...
    public sealed partial class ListAgentRunStepsResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.IList<global::Speechify.AgentRunStep> Steps { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAgentRunStepsResponse" /> class.
        /// </summary>
        /// <param name="hasMore">
        /// True when more rows exist beyond this page.
        /// </param>
...
#endif
        public ListAgentRunStepsResponse(
            bool hasMore,
            global::System.Collections.Generic.IList<global::Speechify.AgentRunStep> steps,
            string? nextCursor)
        {
