...
namespace Speechify
{
    public partial class SubpackageTtsSubpackageTtsFlowClient
    {
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement s_UpdateFlowSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_UpdateFlowSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_UpdateFlowSecurityRequirement0,
            };
        ...
        partial void ProcessUpdateFlowResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.TtsFlowGraph> UpdateFlowAsync(
            string id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Speechify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Speechify.AutoSDKHttpResponse<global::Speechify.TtsFlowGraph>> UpdateFlowAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateFlowSecurityRequirements,
                operationName: "UpdateFlowAsync");
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateFlowResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.TtsFlowGraph> UpdateFlowAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Speechify.TtsPutFlowRequest
            {
                Name = name,
                Notes = notes,
                Nodes = nodes,
