...
namespace Speechify
{
    public partial class SubpackageTtsSubpackageTtsAgentsClient
    {
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement s_DetachKnowledgeBaseSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_DetachKnowledgeBaseSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_DetachKnowledgeBaseSecurityRequirement0,
            };
        ...
        partial void ProcessDetachKnowledgeBaseResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DetachKnowledgeBaseSecurityRequirements,
                operationName: "DetachKnowledgeBaseAsync");
            ...
            try
            {
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDetachKnowledgeBaseResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDetachKnowledgeBaseResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
