...
namespace Speechify
{
    ...
    /// </summary>
    public sealed partial class TtsDynamicVariable
    {
        /// <summary>
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Speechify.JsonConverters.TtsDynamicVariableTypeJsonConverter))]
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Speechify.TtsDynamicVariableType Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TtsDynamicVariable" /> class.
        /// </summary>
        /// <param name="key">
        /// Variable name. Must match `[a-zA-Z0-9_]+`. The `system__` prefix<br/>
        /// is reserved for platform-populated variables and will be rejected.
...
#endif
        public TtsDynamicVariable(
            string key,
            global::Speechify.TtsDynamicVariableType type,
            object? @default,
            string? description)
        {
