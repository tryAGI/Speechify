...
namespace Speechify
{
    public partial class SubpackageTtsSubpackageTtsFlowClient
    {


        private static readonly global::Speechify.EndPointSecurityRequirement s_CloneTemplateSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_CloneTemplateSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_CloneTemplateSecurityRequirement0,
            };
        partial void PrepareCloneTemplateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::Speechify.TtsCloneFlowTemplateRequest request);
        ...
        partial void ProcessCloneTemplateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.TtsFlowGraph> CloneTemplateAsync(
            string id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Speechify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Speechify.AutoSDKHttpResponse<global::Speechify.TtsFlowGraph>> CloneTemplateAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CloneTemplateSecurityRequirements,
                operationName: "CloneTemplateAsync");
            ...
            try
            {
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Flow validation failed (or the request body was undecodable). The standard `Error` envelope plus an `issues` array locating each problem for the editor. See the `FlowValidationError` schema. 
                            if ((int)__response.StatusCode == 400)
                            {
                                string? __content_400 = null;
                                global::System.Exception? __exception_400 = null;
                                global::Speechify.TtsFlowValidationError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Speechify.TtsFlowValidationError.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Speechify.ApiException<global::Speechify.TtsFlowValidationError>.Create(
                            ...
                            if ((int)__response.StatusCode == 409)
                            {
                                ...
                                global::Speechify.TtsError? __value_409 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_409 = global::Speechify.TtsError.FromJson(__content_409, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCloneTemplateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Speechify.TtsFlowGraph.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Speechify.AutoSDKHttpResponse<global::Speechify.TtsFlowGraph>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Speechify.TtsFlowGraph.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.TtsFlowGraph> CloneTemplateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Speechify.TtsCloneFlowTemplateRequest
            {
                AgentId = agentId,
            };
