...
namespace Speechify
{
    ...
    public sealed partial class TtsListCallersResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.IList<global::Speechify.TtsCaller> Callers { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TtsListCallersResponse" /> class.
        /// </summary>
        /// <param name="hasMore">
        /// True when more rows exist beyond this page.
        /// </param>
...
#endif
        public TtsListCallersResponse(
            bool hasMore,
            global::System.Collections.Generic.IList<global::Speechify.TtsCaller> callers,
            string? nextCursor)
        {
