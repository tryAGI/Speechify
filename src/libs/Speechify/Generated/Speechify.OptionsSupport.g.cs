...
namespace Speechify
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Speechify.AutoSDKRetryOptions Retry { get; set; } = new global::Speechify.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Speechify.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Speechify.IAutoSDKHook>();
        ...
        public global::Speechify.AutoSDKClientOptions AddHook(
            global::Speechify.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Speechify.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Speechify.AutoSDKClientOptions UseAuthorizationProvider(
            global::Speechify.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Speechify.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Speechify.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Speechify.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Speechify.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Speechify.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Speechify.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Speechify.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Speechify.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Speechify.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Speechify.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Speechify.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Speechify.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Speechify.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Speechify.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Speechify.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Speechify.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Speechify.AutoSDKClientOptions clientOptions,
            global::Speechify.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Speechify.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Speechify.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Speechify.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Speechify.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Speechify.IAutoSDKHook, global::Speechify.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Speechify.AutoSDKHookContext context)
        {
