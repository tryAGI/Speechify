...
namespace Speechify
{
    ...
    public sealed partial class ListFlowVersionsResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.IList<global::Speechify.FlowVersion> Versions { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListFlowVersionsResponse" /> class.
        /// </summary>
        /// <param name="hasMore">
        /// True when more rows exist beyond this page.
        /// </param>
...
#endif
        public ListFlowVersionsResponse(
            bool hasMore,
            global::System.Collections.Generic.IList<global::Speechify.FlowVersion> versions,
            string? nextCursor)
        {
