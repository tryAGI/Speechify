...
namespace Speechify
{
    ...
    /// </summary>
    public enum TtsPhoneNumberSource
    {
        /// <summary>
        /// 
        /// </summary>
    ...
    /// </summary>
    public static class TtsPhoneNumberSourceExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this TtsPhoneNumberSource value)
        {
            return value switch
            {
                TtsPhoneNumberSource.Byoc => "byoc",
                TtsPhoneNumberSource.Livekit => "livekit",
                TtsPhoneNumberSource.Twilio => "twilio",
                TtsPhoneNumberSource.TwilioPurchased => "twilio_purchased",
                TtsPhoneNumberSource.VerifiedCallerId => "verified_caller_id",
        ...
        /// </summary>
        public static TtsPhoneNumberSource? ToEnum(string value)
        {
            return value switch
            {
                "byoc" => TtsPhoneNumberSource.Byoc,
                "livekit" => TtsPhoneNumberSource.Livekit,
                "twilio" => TtsPhoneNumberSource.Twilio,
                "twilio_purchased" => TtsPhoneNumberSource.TwilioPurchased,
                "verified_caller_id" => TtsPhoneNumberSource.VerifiedCallerId,
                _ => null,
            };
        }
    }
