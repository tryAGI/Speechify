...
namespace Speechify
{
    ...
    public sealed partial class QueryStoreDocumentsResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.IList<global::Speechify.StoreDocument> Documents { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryStoreDocumentsResponse" /> class.
        /// </summary>
        /// <param name="hasMore">
        /// True when more rows exist beyond this page.
        /// </param>
...
#endif
        public QueryStoreDocumentsResponse(
            bool hasMore,
            global::System.Collections.Generic.IList<global::Speechify.StoreDocument> documents,
            string? nextCursor)
        {
