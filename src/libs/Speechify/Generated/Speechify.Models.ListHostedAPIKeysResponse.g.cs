...
namespace Speechify
{
    ...
    public sealed partial class ListHostedAPIKeysResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.IList<global::Speechify.HostedAPIKey> Keys { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListHostedAPIKeysResponse" /> class.
        /// </summary>
        /// <param name="hasMore">
        /// True when more rows exist beyond this page.
        /// </param>
...
#endif
        public ListHostedAPIKeysResponse(
            bool hasMore,
            global::System.Collections.Generic.IList<global::Speechify.HostedAPIKey> keys,
            string? nextCursor)
        {
