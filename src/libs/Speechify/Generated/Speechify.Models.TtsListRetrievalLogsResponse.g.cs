...
namespace Speechify
{
    ...
    public sealed partial class TtsListRetrievalLogsResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.IList<global::Speechify.TtsRetrievalLogEntry> Entries { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TtsListRetrievalLogsResponse" /> class.
        /// </summary>
        /// <param name="hasMore">
        /// True when more rows exist beyond this page.
        /// </param>
...
#endif
        public TtsListRetrievalLogsResponse(
            bool hasMore,
            global::System.Collections.Generic.IList<global::Speechify.TtsRetrievalLogEntry> entries,
            string? nextCursor)
        {
