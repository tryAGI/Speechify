...
namespace Speechify
{
    ...
    public sealed partial class ListBatchCallsResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.IList<global::Speechify.BatchCall> Batches { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListBatchCallsResponse" /> class.
        /// </summary>
        /// <param name="hasMore">
        /// True when more rows exist beyond this page.
        /// </param>
...
#endif
        public ListBatchCallsResponse(
            bool hasMore,
            global::System.Collections.Generic.IList<global::Speechify.BatchCall> batches,
            string? nextCursor)
        {
