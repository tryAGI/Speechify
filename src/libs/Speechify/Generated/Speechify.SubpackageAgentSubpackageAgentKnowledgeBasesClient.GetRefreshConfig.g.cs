...
namespace Speechify
{
    public partial class SubpackageAgentSubpackageAgentKnowledgeBasesClient
    {
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement s_GetRefreshConfigSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_GetRefreshConfigSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_GetRefreshConfigSecurityRequirement0,
            };
        partial void PrepareGetRefreshConfigArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string kbId,
            ref string documentId,
            ref string? speechifyVersion);
        partial void PrepareGetRefreshConfigRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string kbId,
            string documentId,
            string? speechifyVersion);
        partial void ProcessGetRefreshConfigResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetRefreshConfigResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.RefreshConfig> GetRefreshConfigAsync(
            string kbId,
            string documentId,
        ...
        {
            var __response = await GetRefreshConfigAsResponseAsync(
                kbId: kbId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Speechify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Speechify.AutoSDKHttpResponse<global::Speechify.RefreshConfig>> GetRefreshConfigAsResponseAsync(
            string kbId,
            string documentId,
            string? speechifyVersion = default,
            global::Speechify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetRefreshConfigArguments(
            ...
            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetRefreshConfigSecurityRequirements,
                operationName: "GetRefreshConfigAsync");
            ...
            if (speechifyVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetRefreshConfigRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Speechify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetRefreshConfigAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetRefreshConfigResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetRefreshConfigResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Speechify.RefreshConfig.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Speechify.AutoSDKHttpResponse<global::Speechify.RefreshConfig>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Speechify.RefreshConfig.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
