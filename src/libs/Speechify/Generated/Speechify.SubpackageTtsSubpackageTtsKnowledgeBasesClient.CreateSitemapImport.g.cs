...
namespace Speechify
{
    public partial class SubpackageTtsSubpackageTtsKnowledgeBasesClient
    {


        private static readonly global::Speechify.EndPointSecurityRequirement s_CreateSitemapImportSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_CreateSitemapImportSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_CreateSitemapImportSecurityRequirement0,
            };
        partial void PrepareCreateSitemapImportArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::Speechify.TtsCreateSitemapImportRequest request);
        partial void PrepareCreateSitemapImportRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::Speechify.TtsCreateSitemapImportRequest request);
        partial void ProcessCreateSitemapImportResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateSitemapImportResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.TtsImportJobResponse> CreateSitemapImportAsync(
            string id,
        ...
        {
            var __response = await CreateSitemapImportAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Speechify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Speechify.AutoSDKHttpResponse<global::Speechify.TtsImportJobResponse>> CreateSitemapImportAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateSitemapImportArguments(
            ...
            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateSitemapImportSecurityRequirements,
                operationName: "CreateSitemapImportAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Speechify.PathBuilder(
                                path: $"/v1/agents/knowledge-bases/{id}/documents/sitemap",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateSitemapImportRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Speechify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateSitemapImportAsync",
                                pathTemplate: "$\"/v1/agents/knowledge-bases/{id}/documents/sitemap\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateSitemapImportResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateSitemapImportResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Speechify.TtsImportJobResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Speechify.AutoSDKHttpResponse<global::Speechify.TtsImportJobResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Speechify.TtsImportJobResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.TtsImportJobResponse> CreateSitemapImportAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Speechify.TtsCreateSitemapImportRequest
            {
                Url = url,
                FolderId = folderId,
            };

            return await CreateSitemapImportAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
