...
namespace Speechify
{
    ...
    public sealed partial class CredentialInUseErrorDetail
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Speechify.CredentialInUseErrorDetailDetails Details { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CredentialInUseErrorDetail" /> class.
        /// </summary>
        /// <param name="code">
        /// Stable machine-readable error code. Additive only: codes are<br/>
        /// never renamed, only deprecated. SDKs may map each code to a<br/>
...
#endif
        public CredentialInUseErrorDetail(
            global::Speechify.ErrorCode code,
            string message,
            global::Speechify.CredentialInUseErrorDetailDetails details,
