...
namespace Speechify
{
    public partial class KnowledgeBasesClient
    {
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement s_CancelEvaluationSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_CancelEvaluationSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_CancelEvaluationSecurityRequirement0,
            };
        partial void PrepareCancelEvaluationArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string kbId,
            ref string evaluationId,
            ref string? speechifyVersion);
        partial void PrepareCancelEvaluationRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string kbId,
            string evaluationId,
            string? speechifyVersion);
        partial void ProcessCancelEvaluationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCancelEvaluationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.KnowledgeBaseEvaluation> CancelEvaluationAsync(
            string kbId,
            string evaluationId,
        ...
        {
            var __response = await CancelEvaluationAsResponseAsync(
                kbId: kbId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Speechify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Speechify.AutoSDKHttpResponse<global::Speechify.KnowledgeBaseEvaluation>> CancelEvaluationAsResponseAsync(
            string kbId,
            string evaluationId,
            string? speechifyVersion = default,
            global::Speechify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCancelEvaluationArguments(
            ...
            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CancelEvaluationSecurityRequirements,
                operationName: "CancelEvaluationAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Speechify.PathBuilder(
                                path: $"/v1/agents/knowledge-bases/{kbId}/evaluations/{evaluationId}/cancel",
            ...
            if (speechifyVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCancelEvaluationRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Speechify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CancelEvaluationAsync",
                                pathTemplate: "$\"/v1/agents/knowledge-bases/{kbId}/evaluations/{evaluationId}/cancel\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCancelEvaluationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCancelEvaluationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
