...
namespace Speechify
{
    ...
    public sealed partial class ListHostedAPIRoutesResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.IList<global::Speechify.HostedAPIRoute> Routes { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListHostedAPIRoutesResponse" /> class.
        /// </summary>
        /// <param name="hasMore">
        /// True when more rows exist beyond this page.
        /// </param>
...
#endif
        public ListHostedAPIRoutesResponse(
            bool hasMore,
            global::System.Collections.Generic.IList<global::Speechify.HostedAPIRoute> routes,
            string? nextCursor)
        {
