...
namespace Speechify
{
    public partial class SubpackageTtsSubpackageTtsAdminClient
    {
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement s_ForceEndSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_ForceEndSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_ForceEndSecurityRequirement0,
            };
        ...
        partial void ProcessForceEndResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ForceEndSecurityRequirements,
                operationName: "ForceEndAsync");
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessForceEndResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
