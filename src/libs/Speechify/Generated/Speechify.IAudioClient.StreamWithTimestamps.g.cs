...
namespace Speechify
{
    public partial interface IAudioClient
    {
        ...
        /// duration.<br/>
        /// Speech marks are produced by the streaming-native models. Use<br/>
        /// `simba-3.0` or `simba-3.2`; the legacy `simba-english` and<br/>
        /// `simba-multilingual` models return 400 `speech_marks_unsupported` here.<br/>
