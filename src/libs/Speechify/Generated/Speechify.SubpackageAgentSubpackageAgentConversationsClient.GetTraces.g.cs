...
namespace Speechify
{
    public partial class SubpackageAgentSubpackageAgentConversationsClient
    {
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement s_GetTracesSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_GetTracesSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_GetTracesSecurityRequirement0,
            };
        ...
        partial void ProcessGetTracesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetTracesSecurityRequirements,
                operationName: "GetTracesAsync");
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTracesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Speechify.ConversationTrace.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Speechify.AutoSDKHttpResponse<global::Speechify.ConversationTrace>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Speechify.ConversationTrace.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
