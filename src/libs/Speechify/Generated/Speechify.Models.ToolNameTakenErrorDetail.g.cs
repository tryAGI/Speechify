...
namespace Speechify
{
    ...
    public sealed partial class ToolNameTakenErrorDetail
    {
        ...
        public global::Speechify.ToolNameTakenErrorDetailDetails? Details { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolNameTakenErrorDetail" /> class.
        /// </summary>
        /// <param name="code">
        /// Stable machine-readable error code. Additive only: codes are<br/>
        /// never renamed, only deprecated. SDKs may map each code to a<br/>
