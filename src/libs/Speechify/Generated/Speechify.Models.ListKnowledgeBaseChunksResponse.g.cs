...
namespace Speechify
{
    ...
    public sealed partial class ListKnowledgeBaseChunksResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.IList<global::Speechify.KnowledgeBaseChunk> Chunks { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListKnowledgeBaseChunksResponse" /> class.
        /// </summary>
        /// <param name="hasMore">
        /// True when more rows exist beyond this page.
        /// </param>
...
#endif
        public ListKnowledgeBaseChunksResponse(
            bool hasMore,
            global::System.Collections.Generic.IList<global::Speechify.KnowledgeBaseChunk> chunks,
            string? nextCursor)
        {
