...
namespace Speechify
{
    ...
    public sealed partial class TtsDataAssertion
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Speechify.JsonConverters.TtsDataAssertionModeJsonConverter))]
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Speechify.TtsDataAssertionMode Mode { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TtsDataAssertion" /> class.
        /// </summary>
        /// <param name="key">
        /// Name of the data-collection field on the agent's evaluation config. The assertion fails when this key is missing from the extracted data.
        /// </param>
...
#endif
        public TtsDataAssertion(
            string key,
            global::Speechify.TtsDataAssertionMode mode,
            string? expected,
            string? criteria)
        {
