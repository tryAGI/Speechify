...
namespace Speechify
{
    ...
    public sealed partial class AgentInUseErrorDetail
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Speechify.AgentInUseErrorDetailDetails Details { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentInUseErrorDetail" /> class.
        /// </summary>
        /// <param name="code">
        /// Stable machine-readable error code. Additive only: codes are<br/>
        /// never renamed, only deprecated. SDKs may map each code to a<br/>
...
#endif
        public AgentInUseErrorDetail(
            global::Speechify.ErrorCode code,
            string message,
            global::Speechify.AgentInUseErrorDetailDetails details,
