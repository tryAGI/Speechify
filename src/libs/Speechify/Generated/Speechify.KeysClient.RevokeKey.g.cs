...
namespace Speechify
{
    public partial class KeysClient
    {
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement s_RevokeKeySecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_RevokeKeySecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_RevokeKeySecurityRequirement0,
            };
        partial void PrepareRevokeKeyArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string apiId,
            ref string consumerKeyId,
            ref string? speechifyVersion);
        partial void PrepareRevokeKeyRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string apiId,
            string consumerKeyId,
            string? speechifyVersion);
        partial void ProcessRevokeKeyResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRevokeKeyResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Revoke Consumer Key<br/>
        /// Revoke a consumer key; idempotent. Requests carrying it are refused from now on.<br/>
        /// Dark launch: requires the `hosted_apis_access` entitlement (402 `hosted_apis_not_in_plan` otherwise).
        /// </summary>
        /// <param name="apiId"></param>
        /// <param name="consumerKeyId"></param>
        /// <param name="speechifyVersion"></param>
        /// <param name="requestOptions">Per-request overrides such as headers, query parameters, timeout, retries, and response buffering.</param>
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Speechify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Speechify.HostedAPIKey> RevokeKeyAsync(
            string apiId,
            string consumerKeyId,
        ...
        {
            var __response = await RevokeKeyAsResponseAsync(
                apiId: apiId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Speechify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Speechify.AutoSDKHttpResponse<global::Speechify.HostedAPIKey>> RevokeKeyAsResponseAsync(
            string apiId,
            string consumerKeyId,
            string? speechifyVersion = default,
            global::Speechify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRevokeKeyArguments(
                httpClient: HttpClient,
                apiId: ref apiId,
                consumerKeyId: ref consumerKeyId,
                speechifyVersion: ref speechifyVersion);


            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_RevokeKeySecurityRequirements,
                operationName: "RevokeKeyAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Speechify.PathBuilder(
                                path: $"/v1/apis/{apiId}/keys/{consumerKeyId}/revoke",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Speechify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RevokeKeyAsync",
                                pathTemplate: "$\"/v1/apis/{apiId}/keys/{consumerKeyId}/revoke\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRevokeKeyResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Speechify.HostedAPIKey.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Speechify.AutoSDKHttpResponse<global::Speechify.HostedAPIKey>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Speechify.HostedAPIKey.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
