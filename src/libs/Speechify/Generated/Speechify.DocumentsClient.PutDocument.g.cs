...
namespace Speechify
{
    public partial class DocumentsClient
    {
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement s_PutDocumentSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_PutDocumentSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_PutDocumentSecurityRequirement0,
            };
        partial void PreparePutDocumentArguments(
        ...
        partial void ProcessPutDocumentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.StoreDocument> PutDocumentAsync(
            string storeId,
            string collection,
            string documentId,
        ...
        {
            var __response = await PutDocumentAsResponseAsync(
                storeId: storeId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Speechify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Speechify.AutoSDKHttpResponse<global::Speechify.StoreDocument>> PutDocumentAsResponseAsync(
            string storeId,
            string collection,
            string documentId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PutDocumentSecurityRequirements,
                operationName: "PutDocumentAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Speechify.PathBuilder(
                                path: $"/v1/stores/{storeId}/collections/{collection}/documents/{documentId}",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Speechify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PutDocumentAsync",
                                pathTemplate: "$\"/v1/stores/{storeId}/collections/{collection}/documents/{documentId}\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPutDocumentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Speechify.StoreDocument.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Speechify.AutoSDKHttpResponse<global::Speechify.StoreDocument>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Speechify.StoreDocument.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.StoreDocument> PutDocumentAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Speechify.WriteStoreDocumentRequest
            {
                Id = id,
                Data = data,
            };
