...
namespace Speechify
{
    public partial class SubpackageTtsSubpackageTtsConversationsClient
    {
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement s_StreamRecordingSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_StreamRecordingSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_StreamRecordingSecurityRequirement0,
            };
        ...
        partial void ProcessStreamRecordingResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_StreamRecordingSecurityRequirements,
                operationName: "StreamRecordingAsync");
            ...
            try
            {
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessStreamRecordingResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            try
                            {
                                ...
                                return new global::Speechify.ResponseStream(__response, __content);
                            }
                            catch (global::System.Exception __ex)
                            {
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessStreamRecordingResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                ...
                                try
                                {
                                    ...
                                    return new global::Speechify.AutoSDKHttpResponse<byte[]>(
                                        statusCode: __response.StatusCode,
