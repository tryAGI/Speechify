...
namespace Speechify
{
    public partial class ContactsClient
    {
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement s_DetachIdentifierSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_DetachIdentifierSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_DetachIdentifierSecurityRequirement0,
            };
        partial void PrepareDetachIdentifierArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string contactId,
            ref string identifierId,
            ref string? speechifyVersion);
        partial void PrepareDetachIdentifierRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string contactId,
            string identifierId,
            string? speechifyVersion);
        partial void ProcessDetachIdentifierResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDetachIdentifierResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> DetachIdentifierAsync(
            string contactId,
            string identifierId,
        ...
        {
            var __response = await DetachIdentifierAsResponseAsync(
                contactId: contactId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Speechify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Speechify.AutoSDKHttpResponse<string>> DetachIdentifierAsResponseAsync(
            string contactId,
            string identifierId,
            string? speechifyVersion = default,
            global::Speechify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDetachIdentifierArguments(
                httpClient: HttpClient,
                contactId: ref contactId,
                identifierId: ref identifierId,
                speechifyVersion: ref speechifyVersion);


            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_DetachIdentifierSecurityRequirements,
                operationName: "DetachIdentifierAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Speechify.PathBuilder(
                                path: $"/v1/contacts/{contactId}/identifiers/{identifierId}",
            ...
            if (speechifyVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDetachIdentifierRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Speechify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DetachIdentifier",
                                methodName: "DetachIdentifierAsync",
                                pathTemplate: "$\"/v1/contacts/{contactId}/identifiers/{identifierId}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDetachIdentifierResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDetachIdentifierResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
