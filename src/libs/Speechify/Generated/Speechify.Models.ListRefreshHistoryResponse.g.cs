...
namespace Speechify
{
    ...
    public sealed partial class ListRefreshHistoryResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.IList<global::Speechify.RefreshHistoryEntry> Entries { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListRefreshHistoryResponse" /> class.
        /// </summary>
        /// <param name="hasMore">
        /// True when more rows exist beyond this page.
        /// </param>
...
#endif
        public ListRefreshHistoryResponse(
            bool hasMore,
            global::System.Collections.Generic.IList<global::Speechify.RefreshHistoryEntry> entries,
            string? nextCursor)
        {
