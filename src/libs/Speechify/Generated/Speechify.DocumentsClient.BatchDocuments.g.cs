...
namespace Speechify
{
    public partial class DocumentsClient
    {
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement s_BatchDocumentsSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_BatchDocumentsSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_BatchDocumentsSecurityRequirement0,
            };
        partial void PrepareBatchDocumentsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string storeId,
            ref string collection,
            ref string? speechifyVersion,
            ref string? idempotencyKey,
            global::Speechify.StoreBatchRequest request);
        partial void PrepareBatchDocumentsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::Speechify.StoreBatchRequest request);
        partial void ProcessBatchDocumentsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBatchDocumentsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.StoreBatchResponse> BatchDocumentsAsync(
            string storeId,
            string collection,
        ...
        {
            var __response = await BatchDocumentsAsResponseAsync(
                storeId: storeId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Speechify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Speechify.AutoSDKHttpResponse<global::Speechify.StoreBatchResponse>> BatchDocumentsAsResponseAsync(
            string storeId,
            string collection,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBatchDocumentsArguments(
            ...
            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_BatchDocumentsSecurityRequirements,
                operationName: "BatchDocumentsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Speechify.PathBuilder(
                                path: $"/v1/stores/{storeId}/collections/{collection}/documents/batch",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Speechify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BatchDocuments",
                                methodName: "BatchDocumentsAsync",
                                pathTemplate: "$\"/v1/stores/{storeId}/collections/{collection}/documents/batch\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBatchDocumentsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Speechify.StoreBatchResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Speechify.AutoSDKHttpResponse<global::Speechify.StoreBatchResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Speechify.StoreBatchResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.StoreBatchResponse> BatchDocumentsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Speechify.StoreBatchRequest
            {
                Writes = writes,
            };

            return await BatchDocumentsAsync(
                storeId: storeId,
                collection: collection,
                speechifyVersion: speechifyVersion,
                idempotencyKey: idempotencyKey,
