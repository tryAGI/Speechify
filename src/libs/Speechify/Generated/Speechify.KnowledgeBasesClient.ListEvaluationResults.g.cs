...
namespace Speechify
{
    public partial class KnowledgeBasesClient
    {
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement s_ListEvaluationResultsSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_ListEvaluationResultsSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_ListEvaluationResultsSecurityRequirement0,
            };
        partial void PrepareListEvaluationResultsArguments(
        ...
        partial void PrepareListEvaluationResultsRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessListEvaluationResultsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListEvaluationResultsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// List Knowledge Base Evaluation Results<br/>
        /// The per-case outcomes of an evaluation, in case order.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.ListKnowledgeBaseEvaluationResultsResponse> ListEvaluationResultsAsync(
            string kbId,
            string evaluationId,
        ...
        {
            var __response = await ListEvaluationResultsAsResponseAsync(
                kbId: kbId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Speechify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Speechify.AutoSDKHttpResponse<global::Speechify.ListKnowledgeBaseEvaluationResultsResponse>> ListEvaluationResultsAsResponseAsync(
            string kbId,
            string evaluationId,
            string? cursor = default,
            int? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListEvaluationResultsArguments(
            ...
            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListEvaluationResultsSecurityRequirements,
                operationName: "ListEvaluationResultsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Speechify.PathBuilder(
                                path: $"/v1/agents/knowledge-bases/{kbId}/evaluations/{evaluationId}/results",
            ...
            if (speechifyVersion != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListEvaluationResultsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Speechify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListEvaluationResultsAsync",
                                pathTemplate: "$\"/v1/agents/knowledge-bases/{kbId}/evaluations/{evaluationId}/results\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListEvaluationResultsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListEvaluationResultsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Speechify.ListKnowledgeBaseEvaluationResultsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Speechify.AutoSDKHttpResponse<global::Speechify.ListKnowledgeBaseEvaluationResultsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Speechify.ListKnowledgeBaseEvaluationResultsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
