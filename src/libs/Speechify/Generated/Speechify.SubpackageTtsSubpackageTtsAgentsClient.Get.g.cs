...
namespace Speechify
{
    public partial class SubpackageTtsSubpackageTtsAgentsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.TtsAgent> GetAsync(
            string id,
                    ...
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Speechify.TtsAgent.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Speechify.TtsAgent.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
