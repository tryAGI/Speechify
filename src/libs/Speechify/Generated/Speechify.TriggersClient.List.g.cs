...
namespace Speechify
{
    public partial class TriggersClient
    {
        ...
        /// <summary>
        /// List Agent Triggers<br/>
        /// List a task agent's triggers, most recently updated first.<br/>
        /// Cursor-paginated: omit `cursor` to fetch the first page. Default page<br/>
        /// size is 50 and max is 200. Walk pages while `has_more` is true.
        /// </summary>
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.ListAgentTriggersResponse> ListAsync(
            string agentId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Speechify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Speechify.AutoSDKHttpResponse<global::Speechify.ListAgentTriggersResponse>> ListAsResponseAsync(
            string agentId,
            string? cursor = default,
            int? limit = default,
            string? speechifyVersion = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Speechify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/v1/agents/{agentId}/triggers\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Speechify.ListAgentTriggersResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Speechify.AutoSDKHttpResponse<global::Speechify.ListAgentTriggersResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Speechify.ListAgentTriggersResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
