...
namespace Speechify
{
    ...
    public sealed partial class ListFlowTemplatesResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.IList<global::Speechify.FlowTemplate> Templates { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListFlowTemplatesResponse" /> class.
        /// </summary>
        /// <param name="hasMore">
        /// True when more rows exist beyond this page.
        /// </param>
...
#endif
        public ListFlowTemplatesResponse(
            bool hasMore,
            global::System.Collections.Generic.IList<global::Speechify.FlowTemplate> templates,
            string? nextCursor)
        {
