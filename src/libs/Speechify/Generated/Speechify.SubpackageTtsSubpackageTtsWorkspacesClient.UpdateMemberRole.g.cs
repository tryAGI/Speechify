...
namespace Speechify
{
    public partial class SubpackageTtsSubpackageTtsWorkspacesClient
    {


        private static readonly global::Speechify.EndPointSecurityRequirement s_UpdateMemberRoleSecurityRequirement0 =
        ...
        private static readonly global::Speechify.EndPointSecurityRequirement[] s_UpdateMemberRoleSecurityRequirements =
            new global::Speechify.EndPointSecurityRequirement[]
            {                s_UpdateMemberRoleSecurityRequirement0,
            };
        partial void PrepareUpdateMemberRoleArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string userUid,
            global::Speechify.TtsUpdateMemberRoleRequest request);
        partial void PrepareUpdateMemberRoleRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string userUid,
            global::Speechify.TtsUpdateMemberRoleRequest request);
        partial void ProcessUpdateMemberRoleResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateMemberRoleResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.TtsMember> UpdateMemberRoleAsync(
            string userUid,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateMemberRoleArguments(
            ...
            var __authorizations = global::Speechify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateMemberRoleSecurityRequirements,
                operationName: "UpdateMemberRoleAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            var __pathBuilder = new global::Speechify.PathBuilder(
                                path: $"/v1/tenants/current/members/{userUid}",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Speechify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateMemberRoleAsync",
                                pathTemplate: "$\"/v1/tenants/current/members/{userUid}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateMemberRoleResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Speechify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateMemberRoleResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Speechify.TtsMember.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Speechify.TtsMember.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Speechify.TtsMember> UpdateMemberRoleAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Speechify.TtsUpdateMemberRoleRequest
            {
                Role = role,
            };

            return await UpdateMemberRoleAsync(
                userUid: userUid,
                request: __request,
                requestOptions: requestOptions,
