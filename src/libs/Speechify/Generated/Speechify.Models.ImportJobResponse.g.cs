...
namespace Speechify
{
    ...
    public sealed partial class ImportJobResponse
    {
        ...
        public required global::Speechify.ImportJob Job { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportJobResponse" /> class.
        /// </summary>
        /// <param name="job">
        /// Async URL import job (sitemap, crawl, plus<br/>
        /// the auto-refresh path). The console polls<br/>
        ...
        public ImportJobResponse(
            global::Speechify.ImportJob job)
        {
