...
namespace Speechify
{
    ...
    public sealed partial class TtsListSuiteRunsResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.IList<global::Speechify.TtsAgentTestSuiteRun> SuiteRuns { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TtsListSuiteRunsResponse" /> class.
        /// </summary>
        /// <param name="hasMore">
        /// True when more rows exist beyond this page.
        /// </param>
...
#endif
        public TtsListSuiteRunsResponse(
            bool hasMore,
            global::System.Collections.Generic.IList<global::Speechify.TtsAgentTestSuiteRun> suiteRuns,
            string? nextCursor)
        {
