...
The Speechify SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Speechify
```
...
using var client = new SpeechifyClient(
    apiKey: Environment.GetEnvironmentVariable("SPEECHIFY_API_KEY")!);
